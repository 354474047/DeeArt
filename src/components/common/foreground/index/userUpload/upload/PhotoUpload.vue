      ...
      <form>
        <div class="photo-body">
          <div class="photo-left">
            ...
            <input style="opacity: 0;" class="photo-file" id="file" type="file" name="file"/>
            <div>添加一张图片</div>
          </div>
          <div class="photo-right">
            <img class="show-photo" src="" id="show" width="200">
          </div>
        </div>
...
.inputBox {
  height: 300px;
  width: 300px;
  background-image: url("../../../../../../assets/img/upload/photoUpload/photoUpload.png");
...
.photo-right {
  width: 350px;
  height: 350px;
  border: 1px solid rgba(163, 155, 155, 0.5);
